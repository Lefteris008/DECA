...
else //Αν δόθηκαν όλα τα στοιχεία, ξεκινάμε τον έλεγχο
{
	...
	$insert = mysql_query("INSERT INTO users (username, password, email, surname, name, dateofbirth, fathersname, mothersname, adt, afm, address, phonehome, phonemobile, serviceid, type, citizenship, nationality, country) VALUES ('$username', '$password', '$email', '$surname', '$name', '0', '0', '0', '0', '0', '0', '0', '0', '$serviceid', '1', '0', '0', '0')"); 
